...
export function ConfirmAmount({
	...
	return (
		<div>
			<h1 className="text-xl font-bold">2. Confirm Package</h1>
			<div className="">
				...
				<div className="mt-5">
						...
						<div className="mt-2 flex items-center">
							...
							<p className="ml-3 text-base font-bold text-gray-900">
								...
								<span className="text-xs font-normal text-gray-400">
									(monthly auto renewal{period > 1 ? 'after cycle' : ''})
								</span>
							</p>
						</div>
					) : null}
					...
					{isWalletLow ? (
						<div className="mt-3 border-l-4 border-yellow-400 bg-yellow-50 p-4">
							<div className="flex">

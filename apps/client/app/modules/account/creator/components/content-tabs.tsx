...
import {HeartIcon, PhotoIcon} from '@heroicons/react/24/solid'
...
export function Tabs() {
  ...
  const tabs = useMemo(
    () => [
      {
        name: 'Photos',
        href: PAGES.CREATOR.PHOTOS.replace(
          ':username',
      ...
      {
        name: 'Likes',
        href: PAGES.CREATOR.LIKES.replace(
          ':username',
          safeString(usernameParam),
        ),
        icon: HeartIcon,
        current:
          PAGES.CREATOR.LIKES.replace(
            ':username',
            safeString(usernameParam),
          ) === location.pathname,
        count: '4',
      },
      {
        ...
        count: '6',
        current:
          PAGES.CREATOR.COLLECTIONS.replace(
            ':username',
            safeString(usernameParam),
          ) === location.pathname,
      },

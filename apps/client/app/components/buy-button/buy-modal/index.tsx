    ...
    return (
        <div className="rounded-lg border border-gray-200 bg-white">
            <div className="p-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <div className="flex w-full flex-col gap-1 ">
                        ...
                        <div>
                            <span className="text-xs">This wallet is your default payment method for all purchases on this website.</span>
                        </div>
            ...
            <div className=" flex justify-end gap-2 border-t border-gray-200 px-4 py-2">
                <Button isLink href="/account/wallet" size='sm' variant="outlined" className="gap-1">
                    Manage
                </Button>
            </div>
        </div>

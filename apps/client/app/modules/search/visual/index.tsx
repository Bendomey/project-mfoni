        ...
        <>
            ...
            <div className="max-w-8xl mx-auto px-4 lg:px-8">
...

                {
                    isPending || !data ? null : (
                        <div className="mt-10">
                            <h1 className="font-extrabold text-3xl md:text-4xl">Visual Search</h1>
                            <p className="mt-2 text-sm">Showing <b>{data?.results?.total}</b> visually similar results to your image.</p>
                            {
                                data?.imageUrl ? (
                                    <div className="mt-8 mb-1">
                                        <img src={data?.imageUrl} className="h-36 w-auto ring-2 ring-black p-1 rounded-sm" alt="captured_image" />
                                    </div>
                                ) : null
                            }
                        </div>

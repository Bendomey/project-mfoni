				...
				<>
					...
					<div className="relative mt-2">
						...
						<Transition
							...
							leaveTo="opacity-0"
						>
							<div className="fixed inset-0 z-50 grid cursor-pointer place-items-center overflow-y-scroll bg-slate-900/20 backdrop-blur-sm">
								<Listbox.Options className="absolute z-10 mx-24 max-h-64 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
									{categories.map((item) => (
										<Listbox.Option
											key={item.name}
											className={({ active }) =>

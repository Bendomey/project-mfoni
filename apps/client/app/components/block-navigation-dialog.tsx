  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        <h1 className="font-bold mt-5 text-center text-xl">You have unsaved changes.</h1>

        <p className="mt-1 text-gray-600 text-center text-sm">Are you sure you want to leave?</p>

    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg ">
                ...
                <div className="flex items-end justify-between">
                    <div className="flex flex-col gap-1">
                        <div className="flex items-center gap-2">
                            <h1 className="font-bold">Snap & Share</h1>
                        ...
                        <p className="text-xs text-gray-500">Our most popular plan for starters</p>
                    </div>
            ...
            <div className="border-t border-gray-200 px-4 py-2 flex justify-end">
                ...
                {/* <Button>Change <ArrowPathIcon className="h-3 w-auto" /></Button>: Use this when their billing package is ADVANCED else use upgrade */}
            </div>
        </div>
    );
}
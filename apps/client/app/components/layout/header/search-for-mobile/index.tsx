            ...
            <div className="flex flex-row items-center justify-between px-3">
                ...
                <div>
                    <div className="flex flex-row items-center rounded-lg bg-zinc-100">
                        <Button onClick={() => setActiveMenu(MENUS.TEXT_SEARCH)} variant="unstyled" externalClassName={`p-4 ${activeMenu === MENUS.TEXT_SEARCH ? 'bg-zinc-300 rounded-l-lg' : ''} `}>
                            <MagnifyingGlassIcon className="h-5 w-5" />
                        </Button>
                        <Button onClick={() => setActiveMenu(MENUS.VISUAL_SEARCH)} variant="unstyled" externalClassName={`p-4 ${activeMenu === MENUS.VISUAL_SEARCH ? 'bg-zinc-300 rounded-r-lg' : ''} `}>

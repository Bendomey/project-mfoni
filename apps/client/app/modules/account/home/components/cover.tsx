    ...
    <div className="border border-gray-200 bg-white pb-5 rounded-md">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 min-w-0 flex-1 block">
          ...
          <div className="mt-2 flex flex-col sm:mt-2 sm:flex-row sm:items-center sm:flex-wrap gap-3 md:gap-5">
          ...
          {currentUser?.role === 'CREATOR' ? (
            <div className="mt-5 md:mt-2 flex flex-row items-center flex-wrap gap-3 md:gap-1">
              <div>
                <Button
                  variant="unstyled"

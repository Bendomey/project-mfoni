...
export const AccountProvider = ({ children }: PropsWithChildren<Props>) => {
    ...
    const { isOpened: isCreatorApplicationModalOpened, onClose: onCloseCreatorApplicationModal, onOpen: onOpenCreatorApplicationModal } = useDisclosure()
    ...
    }, [onCloseCreatorApplicationModal, onOpenCreatorApplicationModal, searchParams])

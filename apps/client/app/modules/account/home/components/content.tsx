...
import { HeartIcon, PhotoIcon, RectangleStackIcon } from '@heroicons/react/24/solid'
...
export function Contents() {
    return (
        <div>
            <div className='mb-3'>
                <h3 className="text-base font-semibold leading-6 text-gray-900">Your Contents</h3>
                <div className='mt-1'>
                    <Tabs />
...
const tabs = [
    ...
    { name: 'Collections', href: '#', count: '6', current: false, icon: RectangleStackIcon },

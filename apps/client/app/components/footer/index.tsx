...
export const Footer = () => {
	return (
		<footer className="bg-white">
			<div className="max-w-8xl mx-auto px-6 py-14 md:flex md:items-center md:justify-between lg:px-8">
				...
				<div className="mt-8 flex flex-col items-center gap-y-1 md:order-1 md:mt-0 md:flex-row md:gap-10">

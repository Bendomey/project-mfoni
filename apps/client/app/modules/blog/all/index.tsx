...
import { type loader } from '@/routes/blog._index.ts'
		...
		<div className="relative">
			...
			<div className="max-w-8xl mx-auto px-4 py-4 lg:px-8">
				<div className="mt-5">
					...
					<div className="mt-5">
						<p className="w-full font-shantell text-zinc-600 md:w-2/4">
							Learn more about photography, the mfoni community, and the latest
							news from mfoni. We share tips, tricks, and inspiration to help

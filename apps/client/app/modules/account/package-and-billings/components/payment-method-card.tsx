    ...
    return (
        <div className="bg-white border p-5 border-gray-200 rounded-lg ">
            <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-gray-500">Change how you play for your plan.</p>
            </div>

            <div className="mt-5">
                <div className="flex gap-2 md:hidden mb-2">
                    <Button size='sm' >Topup</Button>
                    <Button size='sm' disabled variant='outlined'>Edit</Button>
                </div>
                <div className="rounded-md flex items-start justify-between border border-gray-100 p-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <div className="mt-1">
                                <span className="font-light">GH₵ 500.00</span>
                            </div>
                        </div>
                    </div>
